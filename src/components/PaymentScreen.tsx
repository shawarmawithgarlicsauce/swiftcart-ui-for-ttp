...
export function PaymentScreen({
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#5C1A1A]/5 to-[#8B2E2E]/5 p-6">
      <div className="tablet-container">
        <div className="flex items-center gap-3 mb-6 bg-gradient-to-r from-[#5C1A1A] to-[#8B2E2E] p-4 rounded-lg shadow-md">
