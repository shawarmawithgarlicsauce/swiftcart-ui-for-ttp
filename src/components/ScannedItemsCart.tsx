...
export function ScannedItemsCart({ 
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      {/* Header */}
      <div className="bg-gradient-to-r from-[#5C1A1A] to-[#8B2E2E] text-white sticky top-0 z-10 shadow-lg">
        <div className="max-w-2xl mx-auto p-4">
          ...
          <div className="bg-white/10 backdrop-blur-sm rounded-lg p-3 text-center">
            <p className="text-white/80 text-sm mb-1">Cart Total</p>
      ...
      <div className="max-w-2xl mx-auto p-4 pb-32">
        {scannedItems.length === 0 ? (
          ...
          <>
            {/* Detection Status */}
            <Card className="p-4 mb-4 bg-[#5C1A1A]/5 border-[#5C1A1A]/30">
              <div className="flex items-start gap-3">
                <div className="bg-[#5C1A1A] p-2 rounded-full">
                  <AlertCircle className="w-4 h-4 text-white" />
                </div>
                <div className="flex-1 text-sm">
                  <p className="text-[#5C1A1A]">
                  ...
                  <div className="flex gap-4">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <div className="flex items-center justify-between">
                        <div>
                          <p className="text-primary">RM {item.price.toFixed(2)}</p>
            ...
            <Card className="p-6 mb-6">
              ...
              <div className="space-y-3">
                ...
                <div className="flex justify-between items-center">
                  ...
                  <span className="text-2xl text-primary">RM {total.toFixed(2)}</span>
                </div>
              </div>
            </Card>
          </>
          ...
          <div className="max-w-2xl mx-auto p-4">
            <div className="flex items-center gap-4">
              <div className="flex-1">
                ...
                <p className="text-xl text-primary">RM {total.toFixed(2)}</p>
              </div>
              <Button 
                size="lg"
                onClick={onProceedToPayment}
                className="bg-gradient-to-r from-[#5C1A1A] to-[#8B2E2E] hover:from-[#5C1A1A]/90 hover:to-[#8B2E2E]/90 px-8 shadow-lg"
              >
                Proceed to Payment
              </Button>
            </div>
